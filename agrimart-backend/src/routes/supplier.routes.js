...
const { authenticate, requireSupplier, requireVerifiedSupplier } = require('../middleware/auth');
...
router.put('/orders/:id/status', requireVerifiedSupplier, supplierController.updateOrderStatus);
